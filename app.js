...
var UIController = (function() {
	//creating a central DOMstrings to avoid future bugs if we have to change class names
	var DOMstrings = {
		inputType: '.add__type',
...
var controller = (function(budgetCntrl, UICntrl) {
	...
	var updatePercentages = function() {
		...
		//2.read the percenatges from the budget controller
